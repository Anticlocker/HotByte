...
> Complete Digital Menu & Ordering Platform for HotByte
...
### Customer Features
- ðŸ“± OTP-based registration and login
- ðŸ• Browse menu by categories
- â­ View item ratings and reviews
- ðŸ›’ Add items to cart
- ðŸ’³ Online payment via Razorpay
- ðŸ’µ Cash payment option
- ðŸ“Š Order history and tracking
- âœï¸ Submit ratings and reviews
- ðŸ‘¤ Profile management

### Admin Features
- ðŸ” Secure admin authentication
- ðŸ“‹ Order management (view, update status, delete)
- ðŸ½ï¸ Menu management (add, edit, delete items)
- ðŸ“‚ Category management
- ðŸ‘¥ Customer management
- ðŸ’° Sales reports and analytics
- â­ Ratings management
- ðŸ–¼ï¸ Image upload to CDN
